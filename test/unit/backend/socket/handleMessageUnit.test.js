...
describe("socket message controllers", () => {
  ...
  describe("create message, when the request is", () => {
  ...
  describe("update chat messages, when the request is", () => {
    describe("valid and complete", () => {
      it("should update chat messages and verify them", async () => {
        ...
        conversationStorage.forEach((item) =>
          expect(item.isRead).to.equal(true)
        );
      });
  ...
  describe("mark message as seen, when the request is", () => {
    describe("valid and complete", () => {
  ...
  describe("change chat status, when the request is", () => {
    describe("valid and complete", () => {
